...
//			--MEMBERPWD   NOT NULL VARCHAR2(20)  
//			--MEMBEREMAIL NOT NULL VARCHAR2(100) 
//			--MEMBERNAME  NOT NULL VARCHAR2(10) 
			String sql = "INSERT INTO MEMBER (MEMBER_ID, MEMBER_ADMIN, MEMBER_NAME, MEMBER_PWD, MEMBER_EMAIL, MEMBER_ADDRESS, LOG_STATUS) VALUES (?, DEFAULT, ?, ?, ?, ?, DEFAULT)";
			PreparedStatement pstmt = null;
